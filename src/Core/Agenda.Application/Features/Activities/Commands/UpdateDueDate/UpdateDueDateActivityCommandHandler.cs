...
public class UpdateDueDateActivityCommandHandler : IRequestHandler<UpdateDueDateActivityCommand, Unit>
{
    ...
    public UpdateDueDateActivityCommandHandler(IActivityRepository activityRepository, IUnitOfWork unitOfWork)
    {
        _activityRepository = activityRepository;
        _unitOfWork = unitOfWork;
    }

    public async Task<Unit> Handle(UpdateDueDateActivityCommand request, CancellationToken cancellationToken)
    {
        ...
        activity.UpdateDueDate(request.DueDate);
